...
def main():
    # 명령행 인수 처리
    if len(sys.argv) < 2:
        print("사용법: python create_object_csv.py <csv_file_path> [project_id]")
        print("예시: python create_object_csv.py PROJ-15403_26946.csv")
        print("예시: python create_object_csv.py PROJ-15403_26946.csv 26946")
        return 1
