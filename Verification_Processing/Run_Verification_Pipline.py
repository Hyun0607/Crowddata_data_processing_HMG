"""
품질 검증용 csv 파일 추출 파이프라인 구축 Test
순서: gcs_path_downloader.py -> json_to_csv.py -> csv_with_source_data.py -> create_object_csv.py
"""
...
def main():
    ...
    scripts = [
        ...
        },
       {
        ...
        {
            "path": "create_object_csv.py",
            "name": "5. 오브젝트 CSV 생성",
            "args": [source_project_id, ticket_number]  # 소스 프로젝트 ID, 티켓번호 전달
        }
    ]
